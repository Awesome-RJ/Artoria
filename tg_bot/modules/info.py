...
def info(update: Update, context: CallbackContext):
    ...
    del_msg = message.reply_text(
        "searching info data of user....", parse_mode=ParseMode.HTML
    )
    ...
    if user.id == OWNER_ID:
        ...
        text += (
            "\nThis person is one of my support users! " " He can gban you off the map."
        )
...
@client.on(events.NewMessage(pattern="/ginfo ", from_users=(OFFICERS or [])))
